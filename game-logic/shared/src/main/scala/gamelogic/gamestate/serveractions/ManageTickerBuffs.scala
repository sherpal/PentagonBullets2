...
/** This [[gamelogic.gamestate.serveractions.ServerAction]] triggers the actions of all the ticker buffs in the game for
  * which their last tick was further back in time than their tick rate.
  *
